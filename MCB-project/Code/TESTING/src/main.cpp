...
int main() {
    ...
    ThornBots::DrivetrainSubsystem *driveTrainController = new ThornBots::DrivetrainSubsystem(drivers);
    ThornBots::GimbalSubsystem *turretController = new ThornBots::GimbalSubsystem(drivers);
    ThornBots::Robot *Robot = new ThornBots::Robot(drivers, driveTrainController, turretController);
