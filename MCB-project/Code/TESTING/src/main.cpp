...
int main()
{
    ...
    ThornBots::RobotController *RobotController =
        new ThornBots::RobotController(drivers, driveTrainController, turretController);
    ...
    while (1)
    {
        ...
        drivers->remote
            .read();  // Reading the remote before we check if it is connected yet or not.
