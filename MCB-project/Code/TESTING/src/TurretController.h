...
static tap::algorithms::SmoothPidConfig pid_yaw_conf = {
    180,
    0,
    -30000,
    0,
    ...
    0,
    0,
    0};  //{ 90, 10, -15000, 1, 1000000, 1, 0, 1, 0, 0, 0 };
static tap::algorithms::SmoothPidConfig pid_pitch_conf =
    {800, 0.06, 80, 1500, 1000000, 1, 0, 1, 0, 0, 0};

static constexpr int motor_yaw_max_speed =
    500;  // Not sure if this is the absolute maximum. Need to test. Motor documentation says 320,
          // but it can def spin faster than taproot's 320 rpm.
...
private:
    ...
    /*
     * This function will get the raw angle from the IMU and calculate the angle offset of the
     * turret from the drivetrain
     */
    ...
    tap::motor::DjiMotor motor_yaw = tap::motor::DjiMotor(
        ...
        0,
        0);
    tap::motor::DjiMotor motor_pitch = tap::motor::DjiMotor(
        src::DoNotUse_getDrivers(),
        tap::motor::MotorId::MOTOR6,
        tap::can::CanBus::CAN_BUS2,
        false,
        "Yellow black, yellow black. Ohhh lets spice things up a bit. Black yellow",
        0,
        0);
    tap::motor::DjiMotor motor_indexer = tap::motor::DjiMotor(
        ...
        tap::can::CanBus::CAN_BUS2,
        false,
        "He has a pudding-bowl haircut, brown eyes and a sharp nose",
        0,
        0);
    tap::motor::DjiMotor flywheel_one = tap::motor::DjiMotor(
        src::DoNotUse_getDrivers(),
        ...
        0,
        0);
    tap::motor::DjiMotor flywheel_two = tap::motor::DjiMotor(
        src::DoNotUse_getDrivers(),
