...
public:  // Public Methods
    ...
    /*
     * Call this function to convert the desired RPM for all of motors in the DriveTrainController
     * to a voltage level which would then be sent over CanBus to each of the motor controllers to
