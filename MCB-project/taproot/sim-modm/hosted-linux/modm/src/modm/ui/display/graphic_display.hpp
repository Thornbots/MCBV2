...
public:
     ...
     * \param p		point
     */
    inline void setPixel(glcd::Point p) { this->setPixel(p.x, p.y); }
     ...
     * \param p		point
     */
    inline void clearPixel(glcd::Point p) { this->setPixel(p.x, p.y); }
     ...
     */
    inline void drawLine(glcd::Point start, glcd::Point end)
    {
     ...
     * \param height	Height of rectangle
     */
    inline void drawRectangle(int16_t x, int16_t y, uint16_t width, uint16_t height)
    {
     ...
     * \param height	Height of rectangle
     */
    inline void fillRectangle(int16_t x, int16_t y, uint16_t width, uint16_t height)
    {
     ...
     */
    inline void setCursor(glcd::Point position) { this->cursor = position; }
     ...
     */
    inline void setCursor(int16_t x, int16_t y) { this->cursor = glcd::Point(x, y); }
     ...
     * \param x		Cursor x-position
     */
    inline void setCursorX(int16_t x) { this->cursor.x = x; }
     ...
     * \param y		Cursor y-position
     */
    inline void setCursorY(int16_t y) { this->cursor.y = y; }

    inline glcd::Point getCursor() const { return this->cursor; }
     ...
     * \see		modm::font
     */
    inline void setFont(const uint8_t *newFont) { this->font = modm::accessor::asFlash(newFont); }

    inline void setFont(const modm::accessor::Flash<uint8_t> *font) { this->font = *font; }
