...
struct ArithmeticTraits
{
    static constexpr bool isFloatingPoint
        [[deprecated("use std::is_floating_point_v<T> instead!")]] = std::is_floating_point_v<T>;
    ...
    static constexpr T min [[deprecated("use std::numeric_limits<T>::min() instead!")]] =
        std::numeric_limits<T>::min();
    static constexpr T max [[deprecated("use std::numeric_limits<T>::max() instead!")]] =
        std::numeric_limits<T>::max();
    static constexpr T epsilon [[deprecated("use std::numeric_limits<T>::epsilon() instead!")]] =
