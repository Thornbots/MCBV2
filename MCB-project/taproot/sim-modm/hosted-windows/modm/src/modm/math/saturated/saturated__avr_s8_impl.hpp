...
// ------------------------------------------------------------------------
template <>
Saturated<int8_t>& Saturated<int8_t>::operator+=(const Saturated& other)
{
    asm("add  %[x], %[y]"
        "\n\t"
        "brvc 0f"
...
template <>
Saturated<int8_t> operator-(const Saturated<int8_t>& a)
{
...
// ------------------------------------------------------------------------
template <>
Saturated<int8_t> abs(const Saturated<int8_t>& a)
{
    Saturated<int8_t> temp(a);
    asm("sbrc %[x], 7"
        "\n\t"
