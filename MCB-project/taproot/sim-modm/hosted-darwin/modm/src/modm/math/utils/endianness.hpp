...
inline int16_t fromLittleEndian(int16_t value)
{
...
inline int32_t fromLittleEndian(int32_t value)
{
...
inline int16_t fromBigEndian(int16_t value) { return int16_t(fromBigEndian(uint16_t(value))); }
...
inline int32_t fromBigEndian(int32_t value) { return int32_t(fromBigEndian(uint32_t(value))); }
...
inline int16_t toLittleEndian(int16_t value) { return int16_t(toLittleEndian(uint16_t(value))); }
...
inline int32_t toLittleEndian(int32_t value) { return int32_t(toLittleEndian(uint32_t(value))); }
...
inline int16_t toBigEndian(int16_t value) { return int16_t(toBigEndian(uint16_t(value))); }
...
inline int32_t toBigEndian(int32_t value) { return int32_t(toBigEndian(uint32_t(value))); }
