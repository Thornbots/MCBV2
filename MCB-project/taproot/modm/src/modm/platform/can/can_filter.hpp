...
private:
    ...
    {
    protected:
        modm_always_inline Identifier(uint32_t identifier) : value(identifier) {}

        uint32_t value;

    public:
        modm_always_inline operator uint32_t() const { return value; }
    };
...
public:
    ...
    {
        modm_always_inline ExtendedIdentifier(uint32_t identifier, RemoteRequestStatus rtr = NO_RTR)
    ...
    {
        modm_always_inline ExtendedFilterMask(
            uint32_t identifier,
            RemoteRequestFilter rtr = RTR_MATCH)
    ...
    {
        modm_always_inline StandardIdentifier(uint16_t identifier, RemoteRequestStatus rtr = NO_RTR)
    ...
    {
        modm_always_inline StandardFilterMask(
            uint16_t identifier,
            RemoteRequestFilter rtr = RTR_MATCH)
...
private:
    ...
    {
    protected:
        modm_always_inline IdentifierShort(uint16_t identifier) : value(identifier) {}

        uint16_t value;

    public:
        modm_always_inline operator uint16_t() const { return value; }
    };
...
public:
    ...
    {
        modm_always_inline ExtendedIdentifierShort(
            uint32_t identifier,
            RemoteRequestStatus rtr = NO_RTR)
            : IdentifierShort(
                  ((identifier >> 13) & 0xffe0) | ((identifier >> 15) & 0x007f) | 0x08 |
                  ((rtr) ? 0x10 : 0))
        {
        }
    };
    ...
    {
        modm_always_inline ExtendedFilterMaskShort(
            uint32_t identifier,
            RemoteRequestFilter rtr = RTR_MATCH)
            : value(
                  ((identifier >> 13) & 0xffe0) | ((identifier >> 15) & 0x007f) | 0x08 |
    ...
    {
        modm_always_inline StandardIdentifierShort(
            uint16_t identifier,
            RemoteRequestStatus rtr = NO_RTR)
    ...
    {
        modm_always_inline StandardFilterMaskShort(
            uint16_t identifier,
            RemoteRequestFilter rtr = RTR_MATCH)
     ...
     */
    static modm_always_inline void setFilter(
        uint8_t bank,
        Fifo fifo,
     ...
     */
    static modm_always_inline void setIdentifierFilter(
        uint8_t bank,
        Fifo fifo,
        Identifier id,
        Identifier id2)
    ...
    // ----------------------------------------------------------------
    static modm_always_inline void setFilterShort(
        uint8_t bank,
        Fifo fifo,
        StandardIdentifierShort id1,
        StandardFilterMaskShort mask1,
        StandardIdentifierShort id2,
        StandardFilterMaskShort mask2)
    {
        setFilterBase(
            bank,
            fifo | MASK_MODE | DUAL_MODE,
    ...
    static modm_always_inline void setFilterShort(
        ...
        StandardIdentifierShort id1,
        StandardFilterMaskShort mask1,
        ExtendedIdentifierShort id2,
        ExtendedFilterMaskShort mask2)
    {
        setFilterBase(
            bank,
            fifo | MASK_MODE | DUAL_MODE,
    ...
    static modm_always_inline void setFilterShort(
        uint8_t bank,
        Fifo fifo,
        ExtendedIdentifierShort id1,
        ExtendedFilterMaskShort mask1,
        StandardIdentifierShort id2,
        StandardFilterMaskShort mask2)
    {
        setFilterBase(
     ...
     */
    static modm_always_inline void setIdentifierFilterShort(
        uint8_t bank,
        Fifo fifo,
        IdentifierShort id1,
        IdentifierShort id2,
     ...
     */
    static void disableFilter(uint8_t bank);
     ...
     */
    static void setStartFilterBankForCan2(uint8_t startBank);

private:
    static void setFilterBase(uint8_t bank, uint32_t flags, uint32_t fr1, uint32_t fr2);
};
