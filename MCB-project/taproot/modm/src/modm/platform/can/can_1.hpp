...
public:
     ...
     */
    static inline uint8_t getReceiveErrorCounter() { return (CAN1->ESR & CAN_ESR_REC) >> 24; }

    /**
     * Get Transmit Error Counter.
     *
     */
    static inline uint8_t getTransmitErrorCounter() { return (CAN1->ESR & CAN_ESR_TEC) >> 16; }
