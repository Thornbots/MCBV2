...
// ----------------------------------------------------------------------------
void modm::platform::Timer10::clockEnable() { enable(); }

void modm::platform::Timer10::enable() { Rcc::enable<Peripheral::Tim10>(); }

void modm::platform::Timer10::disable()
{
    TIM10->CR1 = 0;
    TIM10->DIER = 0;
    TIM10->CCER = 0;

    Rcc::disable<Peripheral::Tim10>();
}

// ----------------------------------------------------------------------------
void modm::platform::Timer10::setMode(
    Mode mode,
    SlaveMode slaveMode,
    ...
    bool limitUpdateEventRequestSource)
{
    ...
    TIM10->SMCR = static_cast<uint32_t>(slaveMode) | static_cast<uint32_t>(slaveModeTrigger);
}

// ----------------------------------------------------------------------------
void modm::platform::Timer10::configureInputChannel(
    uint32_t channel,
    ...
    bool xor_ch1_3)
{
    ...
    TIM10->CCER |= (TIM_CCER_CC1E | static_cast<uint32_t>(polarity)) << (channel * 4);
}

// ----------------------------------------------------------------------------
void modm::platform::Timer10::configureOutputChannel(
    uint32_t channel,
...
// ----------------------------------------------------------------------------
void modm::platform::Timer10::enableInterruptVector(bool enable, uint32_t priority)
{
    if (enable)
    {
