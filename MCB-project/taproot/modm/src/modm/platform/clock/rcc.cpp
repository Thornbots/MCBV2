...
modm_weak void SystemCoreClockUpdate()
{ /* Nothing to update */
}
...
// ----------------------------------------------------------------------------
bool Rcc::enableInternalClock(uint32_t waitCycles)
{
    bool retval;
    RCC->CR |= RCC_CR_HSION;
...
bool Rcc::enableExternalClock(uint32_t waitCycles)
{
    bool retval;
...
bool Rcc::enableExternalCrystal(uint32_t waitCycles)
{
    bool retval;
...
bool Rcc::enableLowSpeedInternalClock(uint32_t waitCycles)
{
    bool retval;
...
bool Rcc::enableLowSpeedExternalClock(uint32_t waitCycles)
{
    bool retval;
...
bool Rcc::enableLowSpeedExternalCrystal(uint32_t waitCycles)
{
    bool retval;
...
bool Rcc::enablePll(PllSource source, const PllFactors& pllFactors, uint32_t waitCycles)
{
...
// ----------------------------------------------------------------------------
bool Rcc::enableSystemClock(SystemClockSource src, uint32_t waitCycles)
{
