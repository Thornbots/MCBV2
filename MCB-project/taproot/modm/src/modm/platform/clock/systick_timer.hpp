...
public:
    ...
    static void initialize()
    {
        ...
        {
            constexpr auto result =
                Prescaler::from_range(SystemClock::Frequency / 8, 4, 1, (1ul << 24) - 1);
            PeripheralDriver::assertBaudrateInTolerance<result.frequency, 4, tolerance>();
...
private:
    static void enable(uint32_t reload, bool prescaler8);
