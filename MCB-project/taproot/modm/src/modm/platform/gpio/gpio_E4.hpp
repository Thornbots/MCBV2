...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioE4::A20 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct D4
    {
        static void connect();
        static_assert((peripheral == Peripheral::Dcmi), "GpioE4::D4 only connects to Dcmi!");
    };
    template <Peripheral peripheral>
    struct Traced1
    {
        static void connect();
        static_assert((peripheral == Peripheral::Sys), "GpioE4::Traced1 only connects to Sys!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
