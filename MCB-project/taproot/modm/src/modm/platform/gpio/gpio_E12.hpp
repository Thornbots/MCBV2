...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim1), "GpioE12::Ch3n only connects to Tim1!");
    };
    template <Peripheral peripheral>
    struct D9
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioE12::D9 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Da9
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioE12::Da9 only connects to Fsmc!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
struct GpioE12::D9<Peripheral::Fsmc>
{
    using Gpio = GpioE12;
...
template <>
struct GpioE12::Da9<Peripheral::Fsmc>
{
    using Gpio = GpioE12;
