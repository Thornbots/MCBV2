...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioE5::A21 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Ch1
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim9), "GpioE5::Ch1 only connects to Tim9!");
    };
    template <Peripheral peripheral>
    struct D6
    {
        static void connect();
        static_assert((peripheral == Peripheral::Dcmi), "GpioE5::D6 only connects to Dcmi!");
    };
    template <Peripheral peripheral>
    struct Traced2
    {
        static void connect();
        static_assert((peripheral == Peripheral::Sys), "GpioE5::Traced2 only connects to Sys!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
