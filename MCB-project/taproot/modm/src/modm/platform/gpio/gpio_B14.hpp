...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim12), "GpioB14::Ch1 only connects to Tim12!");
    };
    template <Peripheral peripheral>
    struct Ch2n
    {
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2s2), "GpioB14::Extsd only connects to I2s2!");
    };
    template <Peripheral peripheral>
    struct Miso
    {
        static void connect();
        static_assert((peripheral == Peripheral::Spi2), "GpioB14::Miso only connects to Spi2!");
    };
    template <Peripheral peripheral>
    struct Rts
    {
        static void connect();
        static_assert((peripheral == Peripheral::Usart3), "GpioB14::Rts only connects to Usart3!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
