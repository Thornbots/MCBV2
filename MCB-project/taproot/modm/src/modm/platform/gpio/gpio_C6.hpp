...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Dcmi), "GpioC6::D0 only connects to Dcmi!");
    };
    template <Peripheral peripheral>
    struct D6
    {
        static void connect();
        static_assert((peripheral == Peripheral::Sdio), "GpioC6::D6 only connects to Sdio!");
    };
    template <Peripheral peripheral>
    struct Mck
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2s2), "GpioC6::Mck only connects to I2s2!");
    };
    template <Peripheral peripheral>
    struct Tx
    {
        static void connect();
        static_assert((peripheral == Peripheral::Usart6), "GpioC6::Tx only connects to Usart6!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
