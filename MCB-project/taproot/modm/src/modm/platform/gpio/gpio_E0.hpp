...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Dcmi), "GpioE0::D2 only connects to Dcmi!");
    };
    template <Peripheral peripheral>
    struct Etr
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim4), "GpioE0::Etr only connects to Tim4!");
    };
    template <Peripheral peripheral>
    struct Nbl0
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioE0::Nbl0 only connects to Fsmc!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
