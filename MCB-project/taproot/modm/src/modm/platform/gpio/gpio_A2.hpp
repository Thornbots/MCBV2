...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim9), "GpioA2::Ch1 only connects to Tim9!");
    };
    template <Peripheral peripheral>
    struct Ch3
    {
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Eth), "GpioA2::Mdio only connects to Eth!");
    };
    template <Peripheral peripheral>
    struct Tx
    {
        static void connect();
        static_assert((peripheral == Peripheral::Usart2), "GpioA2::Tx only connects to Usart2!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
constexpr int8_t GpioA2::AdcChannel<Peripheral::Adc1> = 2;
template <>
...
template <>
constexpr int8_t GpioA2::AdcChannel<Peripheral::Adc2> = 2;
template <>
...
template <>
constexpr int8_t GpioA2::AdcChannel<Peripheral::Adc3> = 2;
template <>
