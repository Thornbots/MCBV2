...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim3), "GpioB4::Ch1 only connects to Tim3!");
    };
    template <Peripheral peripheral>
    struct Extsd
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2s3), "GpioB4::Extsd only connects to I2s3!");
    };
    template <Peripheral peripheral>
    struct Jtrst
    {
        static void connect();
        static_assert((peripheral == Peripheral::Sys), "GpioB4::Jtrst only connects to Sys!");
    };
    template <Peripheral peripheral>
    struct Miso
    {
