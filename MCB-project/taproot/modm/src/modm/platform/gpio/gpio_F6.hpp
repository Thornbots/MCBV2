...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim10), "GpioF6::Ch1 only connects to Tim10!");
    };
    template <Peripheral peripheral>
    struct In4
    {
        static void connect();
        static_assert((peripheral == Peripheral::Adc3), "GpioF6::In4 only connects to Adc3!");
    };
    template <Peripheral peripheral>
    struct Niord
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioF6::Niord only connects to Fsmc!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
constexpr int8_t GpioF6::AdcChannel<Peripheral::Adc3> = 4;
template <>
struct GpioF6::Niord<Peripheral::Fsmc>
{
    using Gpio = GpioF6;
