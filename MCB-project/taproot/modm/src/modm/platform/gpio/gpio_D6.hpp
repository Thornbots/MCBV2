...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioD6::Nwait only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Rx
    {
        static void connect();
        static_assert((peripheral == Peripheral::Usart2), "GpioD6::Rx only connects to Usart2!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
