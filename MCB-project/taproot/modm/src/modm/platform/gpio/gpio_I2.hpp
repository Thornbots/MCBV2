...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim8), "GpioI2::Ch4 only connects to Tim8!");
    };
    template <Peripheral peripheral>
    struct D9
    {
        static void connect();
        static_assert((peripheral == Peripheral::Dcmi), "GpioI2::D9 only connects to Dcmi!");
    };
    template <Peripheral peripheral>
    struct Extsd
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2s2), "GpioI2::Extsd only connects to I2s2!");
    };
    template <Peripheral peripheral>
    struct Miso
    {
        static void connect();
        static_assert((peripheral == Peripheral::Spi2), "GpioI2::Miso only connects to Spi2!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
