...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim1), "GpioE13::Ch3 only connects to Tim1!");
    };
    template <Peripheral peripheral>
    struct D10
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioE13::D10 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Da10
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioE13::Da10 only connects to Fsmc!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
struct GpioE13::D10<Peripheral::Fsmc>
{
    using Gpio = GpioE13;
...
template <>
struct GpioE13::Da10<Peripheral::Fsmc>
{
    using Gpio = GpioE13;
