...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioD8::D13 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Da13
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioD8::Da13 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Tx
    {
        static void connect();
        static_assert((peripheral == Peripheral::Usart3), "GpioD8::Tx only connects to Usart3!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
struct GpioD8::D13<Peripheral::Fsmc>
{
    using Gpio = GpioD8;
...
template <>
struct GpioD8::Da13<Peripheral::Fsmc>
{
    using Gpio = GpioD8;
