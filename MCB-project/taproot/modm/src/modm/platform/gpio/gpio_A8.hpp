...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim1), "GpioA8::Ch1 only connects to Tim1!");
    };
    template <Peripheral peripheral>
    struct Ck
    {
        static void connect();
        static_assert((peripheral == Peripheral::Usart1), "GpioA8::Ck only connects to Usart1!");
    };
    template <Peripheral peripheral>
    struct Mco1
    {
        static void connect();
        static_assert((peripheral == Peripheral::Rcc), "GpioA8::Mco1 only connects to Rcc!");
    };
    template <Peripheral peripheral>
    struct Scl
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2c3), "GpioA8::Scl only connects to I2c3!");
    };
    template <Peripheral peripheral>
    struct Sof
    {
