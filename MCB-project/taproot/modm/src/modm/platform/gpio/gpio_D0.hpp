...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioD0::D2 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Da2
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioD0::Da2 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Rx
    {
        static void connect();
        static_assert((peripheral == Peripheral::Can1), "GpioD0::Rx only connects to Can1!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
struct GpioD0::D2<Peripheral::Fsmc>
{
    using Gpio = GpioD0;
...
template <>
struct GpioD0::Da2<Peripheral::Fsmc>
{
    using Gpio = GpioD0;
