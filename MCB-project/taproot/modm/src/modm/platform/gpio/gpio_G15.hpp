...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Usart6), "GpioG15::Cts only connects to Usart6!");
    };
    template <Peripheral peripheral>
    struct D13
    {
        static void connect();
        static_assert((peripheral == Peripheral::Dcmi), "GpioG15::D13 only connects to Dcmi!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
