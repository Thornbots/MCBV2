...
template <class StartGpio, int8_t Width>
class GpioPort : public ::modm::GpioPort /** @cond */,
                 public GpioSetShim<StartGpio, Width> /** @endcond */
{
...
struct GpioPortInfo<Gpio::Port::A>
{
    ...
    struct check
    {
        ...
        static_assert(isReversed or width <= Width, "GpioPort Width out of bounds! Maximum is 16.");

        static_assert(
            isReversed or (QueryStartPin + QueryWidth <= EndPin),
            "GpioPort StartPin + Width out of bounds! Maximum is 15.");
        static_assert(
            isNormal or (StartPin <= QueryStartPin + QueryWidth + 1),
...
struct GpioPortInfo<Gpio::Port::I>
{
    ...
    struct check
    {
        ...
        static constexpr bool isReversed = QueryWidth < 0;
        static constexpr int8_t width = isNormal ? QueryWidth : -QueryWidth;
        static_assert(isReversed or width <= Width, "GpioPort Width out of bounds! Maximum is 12.");
...
template <class StartGpio>
struct GpioSetShim<StartGpio, -3>
    : public GpioSet<GpioShim<StartGpio, 0>, GpioShim<StartGpio, -1>, GpioShim<StartGpio, -2> >
{
    static typename GpioPortInfo<StartGpio::port>::template check<StartGpio::pin, -3> check;
};
template <class StartGpio>
struct GpioSetShim<StartGpio, -2> : public GpioSet<GpioShim<StartGpio, 0>, GpioShim<StartGpio, -1> >
{
    static typename GpioPortInfo<StartGpio::port>::template check<StartGpio::pin, -2> check;
};
template <class StartGpio>
struct GpioSetShim<StartGpio, -1> : public GpioSet<GpioShim<StartGpio, 0> >
{
...
template <class StartGpio>
struct GpioSetShim<StartGpio, 2> : public GpioSet<GpioShim<StartGpio, 1>, GpioShim<StartGpio, 0> >
{
    static typename GpioPortInfo<StartGpio::port>::template check<StartGpio::pin, 2> check;
};
template <class StartGpio>
struct GpioSetShim<StartGpio, 3>
    : public GpioSet<GpioShim<StartGpio, 2>, GpioShim<StartGpio, 1>, GpioShim<StartGpio, 0> >
{
    static typename GpioPortInfo<StartGpio::port>::template check<StartGpio::pin, 3> check;
};
template <class StartGpio>
