...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioF9::Cd only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Ch1
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim14), "GpioF9::Ch1 only connects to Tim14!");
    };
    template <Peripheral peripheral>
    struct In7
    {
        static void connect();
        static_assert((peripheral == Peripheral::Adc3), "GpioF9::In7 only connects to Adc3!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
constexpr int8_t GpioF9::AdcChannel<Peripheral::Adc3> = 7;
/// @endcond
