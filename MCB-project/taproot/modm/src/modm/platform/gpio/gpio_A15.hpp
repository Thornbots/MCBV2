...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim2), "GpioA15::Ch1 only connects to Tim2!");
    };
    template <Peripheral peripheral>
    struct Etr
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim2), "GpioA15::Etr only connects to Tim2!");
    };
    template <Peripheral peripheral>
    struct Jtdi
    {
        static void connect();
        static_assert((peripheral == Peripheral::Sys), "GpioA15::Jtdi only connects to Sys!");
    };
    template <Peripheral peripheral>
    struct Nss
    {
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2s3), "GpioA15::Ws only connects to I2s3!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
