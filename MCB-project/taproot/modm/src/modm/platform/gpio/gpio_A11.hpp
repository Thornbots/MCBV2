...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim1), "GpioA11::Ch4 only connects to Tim1!");
    };
    template <Peripheral peripheral>
    struct Cts
    {
        static void connect();
        static_assert((peripheral == Peripheral::Usart1), "GpioA11::Cts only connects to Usart1!");
    };
    template <Peripheral peripheral>
    struct Dm
    {
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Can1), "GpioA11::Rx only connects to Can1!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
