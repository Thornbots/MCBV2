...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim14), "GpioA7::Ch1 only connects to Tim14!");
    };
    template <Peripheral peripheral>
    struct Ch1n
    {
        static void connect();
        static_assert(
            (peripheral == Peripheral::Tim1) || (peripheral == Peripheral::Tim8),
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim3), "GpioA7::Ch2 only connects to Tim3!");
    };
    template <Peripheral peripheral>
    struct In7
    {
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Spi1), "GpioA7::Mosi only connects to Spi1!");
    };
    template <Peripheral peripheral>
    struct Rcccrsdv
    {
        static void connect();
        static_assert((peripheral == Peripheral::Eth), "GpioA7::Rcccrsdv only connects to Eth!");
    };
    template <Peripheral peripheral>
    struct Rxdv
    {
        static void connect();
        static_assert((peripheral == Peripheral::Eth), "GpioA7::Rxdv only connects to Eth!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
constexpr int8_t GpioA7::AdcChannel<Peripheral::Adc1> = 7;
template <>
...
template <>
constexpr int8_t GpioA7::AdcChannel<Peripheral::Adc2> = 7;
template <>
