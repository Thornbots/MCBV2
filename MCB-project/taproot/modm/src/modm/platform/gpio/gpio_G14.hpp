...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioG14::A25 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Tx
    {
        static void connect();
        static_assert((peripheral == Peripheral::Usart6), "GpioG14::Tx only connects to Usart6!");
    };
    template <Peripheral peripheral>
    struct Txd1
    {
        static void connect();
        static_assert((peripheral == Peripheral::Eth), "GpioG14::Txd1 only connects to Eth!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
struct GpioG14::A25<Peripheral::Fsmc>
{
    using Gpio = GpioG14;
