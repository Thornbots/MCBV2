...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioE3::A19 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Traced0
    {
        static void connect();
        static_assert((peripheral == Peripheral::Sys), "GpioE3::Traced0 only connects to Sys!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
struct GpioE3::A19<Peripheral::Fsmc>
{
    using Gpio = GpioE3;
