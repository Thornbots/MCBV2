...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioF4::A4 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct In14
    {
        static void connect();
        static_assert((peripheral == Peripheral::Adc3), "GpioF4::In14 only connects to Adc3!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
struct GpioF4::A4<Peripheral::Fsmc>
{
    using Gpio = GpioF4;
...
template <>
constexpr int8_t GpioF4::AdcChannel<Peripheral::Adc3> = 14;
/// @endcond
