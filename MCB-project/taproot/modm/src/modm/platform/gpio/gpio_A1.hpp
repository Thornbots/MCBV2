...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Eth), "GpioA1::Refclk only connects to Eth!");
    };
    template <Peripheral peripheral>
    struct Rts
    {
        static void connect();
        static_assert((peripheral == Peripheral::Usart2), "GpioA1::Rts only connects to Usart2!");
    };
    template <Peripheral peripheral>
    struct Rx
    {
        static void connect();
        static_assert((peripheral == Peripheral::Uart4), "GpioA1::Rx only connects to Uart4!");
    };
    template <Peripheral peripheral>
    struct Rxclk
    {
        static void connect();
        static_assert((peripheral == Peripheral::Eth), "GpioA1::Rxclk only connects to Eth!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
constexpr int8_t GpioA1::AdcChannel<Peripheral::Adc1> = 1;
template <>
...
template <>
constexpr int8_t GpioA1::AdcChannel<Peripheral::Adc2> = 1;
template <>
...
template <>
constexpr int8_t GpioA1::AdcChannel<Peripheral::Adc3> = 1;
template <>
