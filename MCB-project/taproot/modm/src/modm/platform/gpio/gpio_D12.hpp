...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioD12::A17 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Ale
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioD12::Ale only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Ch1
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim4), "GpioD12::Ch1 only connects to Tim4!");
    };
    template <Peripheral peripheral>
    struct Rts
    {
        static void connect();
        static_assert((peripheral == Peripheral::Usart3), "GpioD12::Rts only connects to Usart3!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
struct GpioD12::A17<Peripheral::Fsmc>
{
    using Gpio = GpioD12;
...
template <>
struct GpioD12::Ale<Peripheral::Fsmc>
{
    using Gpio = GpioD12;
