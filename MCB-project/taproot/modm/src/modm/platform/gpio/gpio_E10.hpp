...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim1), "GpioE10::Ch2n only connects to Tim1!");
    };
    template <Peripheral peripheral>
    struct D7
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioE10::D7 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Da7
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioE10::Da7 only connects to Fsmc!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
struct GpioE10::D7<Peripheral::Fsmc>
{
    using Gpio = GpioE10;
...
template <>
struct GpioE10::Da7<Peripheral::Fsmc>
{
    using Gpio = GpioE10;
