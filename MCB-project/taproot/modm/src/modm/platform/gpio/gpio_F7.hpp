...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim11), "GpioF7::Ch1 only connects to Tim11!");
    };
    template <Peripheral peripheral>
    struct In5
    {
        static void connect();
        static_assert((peripheral == Peripheral::Adc3), "GpioF7::In5 only connects to Adc3!");
    };
    template <Peripheral peripheral>
    struct Nreg
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioF7::Nreg only connects to Fsmc!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
constexpr int8_t GpioF7::AdcChannel<Peripheral::Adc3> = 5;
template <>
struct GpioF7::Nreg<Peripheral::Fsmc>
{
    using Gpio = GpioF7;
