...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Usart2), "GpioA4::Ck only connects to Usart2!");
    };
    template <Peripheral peripheral>
    struct Hsync
    {
        static void connect();
        static_assert((peripheral == Peripheral::Dcmi), "GpioA4::Hsync only connects to Dcmi!");
    };
    template <Peripheral peripheral>
    struct In4
    {
    ...
    struct Nss
    {
        static void connect();
        static_assert(
            (peripheral == Peripheral::Spi1) || (peripheral == Peripheral::Spi3),
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Dac), "GpioA4::Out1 only connects to Dac!");
    };
    template <Peripheral peripheral>
    struct Sof
    {
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2s3), "GpioA4::Ws only connects to I2s3!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
constexpr int8_t GpioA4::AdcChannel<Peripheral::Adc1> = 4;
template <>
...
template <>
constexpr int8_t GpioA4::AdcChannel<Peripheral::Adc2> = 4;
template <>
...
struct GpioA4::Nss<Peripheral::Spi3>
{
    ...
    inline static void connect() { setAlternateFunction(6); }
};
template <>
...
template <>
constexpr int8_t GpioA4::DacChannel<Peripheral::Dac> = 1;
template <>
