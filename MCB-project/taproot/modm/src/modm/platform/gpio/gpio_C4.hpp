...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Eth), "GpioC4::Rxd0 only connects to Eth!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
constexpr int8_t GpioC4::AdcChannel<Peripheral::Adc1> = 14;
template <>
...
template <>
constexpr int8_t GpioC4::AdcChannel<Peripheral::Adc2> = 14;
template <>
