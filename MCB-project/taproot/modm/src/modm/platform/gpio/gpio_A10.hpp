...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim1), "GpioA10::Ch3 only connects to Tim1!");
    };
    template <Peripheral peripheral>
    struct D1
    {
        static void connect();
        static_assert((peripheral == Peripheral::Dcmi), "GpioA10::D1 only connects to Dcmi!");
    };
    template <Peripheral peripheral>
    struct Id
    {
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Usart1), "GpioA10::Rx only connects to Usart1!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
