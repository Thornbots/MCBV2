...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioF2::A2 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Smba
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2c2), "GpioF2::Smba only connects to I2c2!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
struct GpioF2::A2<Peripheral::Fsmc>
{
    using Gpio = GpioF2;
