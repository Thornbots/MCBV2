...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim13), "GpioF8::Ch1 only connects to Tim13!");
    };
    template <Peripheral peripheral>
    struct In6
    {
        static void connect();
        static_assert((peripheral == Peripheral::Adc3), "GpioF8::In6 only connects to Adc3!");
    };
    template <Peripheral peripheral>
    struct Niowr
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioF8::Niowr only connects to Fsmc!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
constexpr int8_t GpioF8::AdcChannel<Peripheral::Adc3> = 6;
template <>
struct GpioF8::Niowr<Peripheral::Fsmc>
{
    using Gpio = GpioF8;
