...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim4), "GpioB7::Ch2 only connects to Tim4!");
    };
    template <Peripheral peripheral>
    struct Nl
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioB7::Nl only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Rx
    {
        static void connect();
        static_assert((peripheral == Peripheral::Usart1), "GpioB7::Rx only connects to Usart1!");
    };
    template <Peripheral peripheral>
    struct Sda
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2c1), "GpioB7::Sda only connects to I2c1!");
    };
    template <Peripheral peripheral>
    struct Vsync
    {
        static void connect();
        static_assert((peripheral == Peripheral::Dcmi), "GpioB7::Vsync only connects to Dcmi!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
struct GpioB7::Nl<Peripheral::Fsmc>
{
    using Gpio = GpioB7;
