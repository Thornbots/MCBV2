...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Usart6), "GpioC8::Ck only connects to Usart6!");
    };
    template <Peripheral peripheral>
    struct D0
    {
        static void connect();
        static_assert((peripheral == Peripheral::Sdio), "GpioC8::D0 only connects to Sdio!");
    };
    template <Peripheral peripheral>
    struct D2
    {
        static void connect();
        static_assert((peripheral == Peripheral::Dcmi), "GpioC8::D2 only connects to Dcmi!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
