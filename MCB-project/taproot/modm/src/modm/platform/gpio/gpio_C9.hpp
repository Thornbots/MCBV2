...
public:
    ...
    struct Ch4
    {
        static void connect();
        static_assert(
            (peripheral == Peripheral::Tim3) || (peripheral == Peripheral::Tim8),
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2s), "GpioC9::Ckin only connects to I2s!");
    };
    template <Peripheral peripheral>
    struct D1
    {
        static void connect();
        static_assert((peripheral == Peripheral::Sdio), "GpioC9::D1 only connects to Sdio!");
    };
    template <Peripheral peripheral>
    struct D3
    {
        static void connect();
        static_assert((peripheral == Peripheral::Dcmi), "GpioC9::D3 only connects to Dcmi!");
    };
    template <Peripheral peripheral>
    struct Mco2
    {
        static void connect();
        static_assert((peripheral == Peripheral::Rcc), "GpioC9::Mco2 only connects to Rcc!");
    };
    template <Peripheral peripheral>
    struct Sda
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2c3), "GpioC9::Sda only connects to I2c3!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
