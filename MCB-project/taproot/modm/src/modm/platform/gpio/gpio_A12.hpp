...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim1), "GpioA12::Etr only connects to Tim1!");
    };
    template <Peripheral peripheral>
    struct Rts
    {
        static void connect();
        static_assert((peripheral == Peripheral::Usart1), "GpioA12::Rts only connects to Usart1!");
    };
    template <Peripheral peripheral>
    struct Tx
    {
        static void connect();
        static_assert((peripheral == Peripheral::Can1), "GpioA12::Tx only connects to Can1!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
