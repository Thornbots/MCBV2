...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim12), "GpioB15::Ch2 only connects to Tim12!");
    };
    template <Peripheral peripheral>
    struct Ch3n
    {
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Spi2), "GpioB15::Mosi only connects to Spi2!");
    };
    template <Peripheral peripheral>
    struct Refin
    {
        static void connect();
        static_assert((peripheral == Peripheral::Rtc), "GpioB15::Refin only connects to Rtc!");
    };
    template <Peripheral peripheral>
    struct Sd
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2s2), "GpioB15::Sd only connects to I2s2!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
