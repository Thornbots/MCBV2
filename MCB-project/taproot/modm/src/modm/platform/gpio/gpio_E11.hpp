...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim1), "GpioE11::Ch2 only connects to Tim1!");
    };
    template <Peripheral peripheral>
    struct D8
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioE11::D8 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Da8
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioE11::Da8 only connects to Fsmc!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
struct GpioE11::D8<Peripheral::Fsmc>
{
    using Gpio = GpioE11;
...
template <>
struct GpioE11::Da8<Peripheral::Fsmc>
{
    using Gpio = GpioE11;
