...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Dcmi), "GpioI3::D10 only connects to Dcmi!");
    };
    template <Peripheral peripheral>
    struct Etr
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim8), "GpioI3::Etr only connects to Tim8!");
    };
    template <Peripheral peripheral>
    struct Mosi
    {
        static void connect();
        static_assert((peripheral == Peripheral::Spi2), "GpioI3::Mosi only connects to Spi2!");
    };
    template <Peripheral peripheral>
    struct Sd
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2s2), "GpioI3::Sd only connects to I2s2!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
