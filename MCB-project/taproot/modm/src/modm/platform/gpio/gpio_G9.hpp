...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioG9::Nce3 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Ne2
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioG9::Ne2 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Rx
    {
        static void connect();
        static_assert((peripheral == Peripheral::Usart6), "GpioG9::Rx only connects to Usart6!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
