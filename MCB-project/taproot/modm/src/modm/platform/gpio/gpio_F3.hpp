...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioF3::A3 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct In9
    {
        static void connect();
        static_assert((peripheral == Peripheral::Adc3), "GpioF3::In9 only connects to Adc3!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
constexpr int8_t GpioF3::AdcChannel<Peripheral::Adc3> = 9;
/// @endcond
