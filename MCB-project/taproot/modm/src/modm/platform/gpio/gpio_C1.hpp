...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Eth), "GpioC1::Mdc only connects to Eth!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
constexpr int8_t GpioC1::AdcChannel<Peripheral::Adc1> = 11;
template <>
...
template <>
constexpr int8_t GpioC1::AdcChannel<Peripheral::Adc2> = 11;
template <>
...
template <>
constexpr int8_t GpioC1::AdcChannel<Peripheral::Adc3> = 11;
template <>
