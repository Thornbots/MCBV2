...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim5), "GpioI0::Ch4 only connects to Tim5!");
    };
    template <Peripheral peripheral>
    struct D13
    {
        static void connect();
        static_assert((peripheral == Peripheral::Dcmi), "GpioI0::D13 only connects to Dcmi!");
    };
    template <Peripheral peripheral>
    struct Nss
    {
        static void connect();
        static_assert((peripheral == Peripheral::Spi2), "GpioI0::Nss only connects to Spi2!");
    };
    template <Peripheral peripheral>
    struct Ws
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2s2), "GpioI0::Ws only connects to I2s2!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
