...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2s3), "GpioC10::Ck only connects to I2s3!");
    };
    template <Peripheral peripheral>
    struct D2
    {
        static void connect();
        static_assert((peripheral == Peripheral::Sdio), "GpioC10::D2 only connects to Sdio!");
    };
    template <Peripheral peripheral>
    struct D8
    {
        static void connect();
        static_assert((peripheral == Peripheral::Dcmi), "GpioC10::D8 only connects to Dcmi!");
    };
    template <Peripheral peripheral>
    struct Sck
    {
        static void connect();
        static_assert((peripheral == Peripheral::Spi3), "GpioC10::Sck only connects to Spi3!");
    };
    template <Peripheral peripheral>
    struct Tx
    {
