...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim4), "GpioD14::Ch3 only connects to Tim4!");
    };
    template <Peripheral peripheral>
    struct D0
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioD14::D0 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Da0
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioD14::Da0 only connects to Fsmc!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
struct GpioD14::D0<Peripheral::Fsmc>
{
    using Gpio = GpioD14;
...
template <>
struct GpioD14::Da0<Peripheral::Fsmc>
{
    using Gpio = GpioD14;
