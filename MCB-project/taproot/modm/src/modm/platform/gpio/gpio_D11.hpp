...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioD11::A16 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Cle
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioD11::Cle only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Cts
    {
        static void connect();
        static_assert((peripheral == Peripheral::Usart3), "GpioD11::Cts only connects to Usart3!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
struct GpioD11::A16<Peripheral::Fsmc>
{
    using Gpio = GpioD11;
...
template <>
struct GpioD11::Cle<Peripheral::Fsmc>
{
    using Gpio = GpioD11;
