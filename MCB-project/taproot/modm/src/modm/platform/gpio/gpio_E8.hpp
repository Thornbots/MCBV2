...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim1), "GpioE8::Ch1n only connects to Tim1!");
    };
    template <Peripheral peripheral>
    struct D5
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioE8::D5 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Da5
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioE8::Da5 only connects to Fsmc!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
struct GpioE8::D5<Peripheral::Fsmc>
{
    using Gpio = GpioE8;
...
template <>
struct GpioE8::Da5<Peripheral::Fsmc>
{
    using Gpio = GpioE8;
