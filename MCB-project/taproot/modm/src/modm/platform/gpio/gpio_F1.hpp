...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioF1::A1 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Scl
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2c2), "GpioF1::Scl only connects to I2c2!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
struct GpioF1::A1<Peripheral::Fsmc>
{
    using Gpio = GpioF1;
