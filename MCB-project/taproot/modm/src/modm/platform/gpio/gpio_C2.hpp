...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2s2), "GpioC2::Extsd only connects to I2s2!");
    };
    template <Peripheral peripheral>
    struct In12
    {
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Spi2), "GpioC2::Miso only connects to Spi2!");
    };
    template <Peripheral peripheral>
    struct Txd2
    {
        static void connect();
        static_assert((peripheral == Peripheral::Eth), "GpioC2::Txd2 only connects to Eth!");
    };
    template <Peripheral peripheral>
    struct Ulpidir
    {
...
template <>
constexpr int8_t GpioC2::AdcChannel<Peripheral::Adc1> = 12;
template <>
...
template <>
constexpr int8_t GpioC2::AdcChannel<Peripheral::Adc2> = 12;
template <>
...
template <>
constexpr int8_t GpioC2::AdcChannel<Peripheral::Adc3> = 12;
template <>
