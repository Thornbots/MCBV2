...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioD13::A18 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Ch2
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim4), "GpioD13::Ch2 only connects to Tim4!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
struct GpioD13::A18<Peripheral::Fsmc>
{
    using Gpio = GpioD13;
