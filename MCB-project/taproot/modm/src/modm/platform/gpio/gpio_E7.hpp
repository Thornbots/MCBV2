...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioE7::D4 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Da4
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioE7::Da4 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Etr
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim1), "GpioE7::Etr only connects to Tim1!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
