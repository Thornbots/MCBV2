...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim1), "GpioA9::Ch2 only connects to Tim1!");
    };
    template <Peripheral peripheral>
    struct D0
    {
        static void connect();
        static_assert((peripheral == Peripheral::Dcmi), "GpioA9::D0 only connects to Dcmi!");
    };
    template <Peripheral peripheral>
    struct Smba
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2c3), "GpioA9::Smba only connects to I2c3!");
    };
    template <Peripheral peripheral>
    struct Tx
    {
        static void connect();
        static_assert((peripheral == Peripheral::Usart1), "GpioA9::Tx only connects to Usart1!");
    };
    template <Peripheral peripheral>
    struct Vbus
    {
