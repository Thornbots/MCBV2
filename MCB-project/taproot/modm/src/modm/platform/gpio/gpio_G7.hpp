...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Usart6), "GpioG7::Ck only connects to Usart6!");
    };
    template <Peripheral peripheral>
    struct Int3
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioG7::Int3 only connects to Fsmc!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
struct GpioG7::Int3<Peripheral::Fsmc>
{
    using Gpio = GpioG7;
