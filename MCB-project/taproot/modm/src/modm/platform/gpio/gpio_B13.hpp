...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim1), "GpioB13::Ch1n only connects to Tim1!");
    };
    template <Peripheral peripheral>
    struct Ck
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2s2), "GpioB13::Ck only connects to I2s2!");
    };
    template <Peripheral peripheral>
    struct Cts
    {
        static void connect();
        static_assert((peripheral == Peripheral::Usart3), "GpioB13::Cts only connects to Usart3!");
    };
    template <Peripheral peripheral>
    struct Sck
    {
        static void connect();
        static_assert((peripheral == Peripheral::Spi2), "GpioB13::Sck only connects to Spi2!");
    };
    template <Peripheral peripheral>
    struct Tx
    {
        static void connect();
        static_assert((peripheral == Peripheral::Can2), "GpioB13::Tx only connects to Can2!");
    };
    template <Peripheral peripheral>
    struct Txd1
    {
        static void connect();
        static_assert((peripheral == Peripheral::Eth), "GpioB13::Txd1 only connects to Eth!");
    };
    template <Peripheral peripheral>
    struct Ulpid6
    {
