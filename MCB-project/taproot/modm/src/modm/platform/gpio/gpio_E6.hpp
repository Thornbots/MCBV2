...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioE6::A22 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Ch2
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim9), "GpioE6::Ch2 only connects to Tim9!");
    };
    template <Peripheral peripheral>
    struct D7
    {
        static void connect();
        static_assert((peripheral == Peripheral::Dcmi), "GpioE6::D7 only connects to Dcmi!");
    };
    template <Peripheral peripheral>
    struct Traced3
    {
        static void connect();
        static_assert((peripheral == Peripheral::Sys), "GpioE6::Traced3 only connects to Sys!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
struct GpioE6::A22<Peripheral::Fsmc>
{
    using Gpio = GpioE6;
