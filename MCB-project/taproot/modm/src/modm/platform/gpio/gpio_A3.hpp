...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim9), "GpioA3::Ch2 only connects to Tim9!");
    };
    template <Peripheral peripheral>
    struct Ch4
    {
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Eth), "GpioA3::Col only connects to Eth!");
    };
    template <Peripheral peripheral>
    struct In3
    {
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Usart2), "GpioA3::Rx only connects to Usart2!");
    };
    template <Peripheral peripheral>
    struct Ulpid0
    {
...
template <>
constexpr int8_t GpioA3::AdcChannel<Peripheral::Adc1> = 3;
template <>
...
template <>
constexpr int8_t GpioA3::AdcChannel<Peripheral::Adc2> = 3;
template <>
...
template <>
constexpr int8_t GpioA3::AdcChannel<Peripheral::Adc3> = 3;
template <>
