...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Spi2), "GpioC3::Mosi only connects to Spi2!");
    };
    template <Peripheral peripheral>
    struct Sd
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2s2), "GpioC3::Sd only connects to I2s2!");
    };
    template <Peripheral peripheral>
    struct Txclk
    {
        static void connect();
        static_assert((peripheral == Peripheral::Eth), "GpioC3::Txclk only connects to Eth!");
    };
    template <Peripheral peripheral>
    struct Ulpinxt
    {
...
template <>
constexpr int8_t GpioC3::AdcChannel<Peripheral::Adc1> = 13;
template <>
...
template <>
constexpr int8_t GpioC3::AdcChannel<Peripheral::Adc2> = 13;
template <>
...
template <>
constexpr int8_t GpioC3::AdcChannel<Peripheral::Adc3> = 13;
template <>
