...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim2), "GpioB11::Ch4 only connects to Tim2!");
    };
    template <Peripheral peripheral>
    struct Rx
    {
        static void connect();
        static_assert((peripheral == Peripheral::Usart3), "GpioB11::Rx only connects to Usart3!");
    };
    template <Peripheral peripheral>
    struct Sda
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2c2), "GpioB11::Sda only connects to I2c2!");
    };
    template <Peripheral peripheral>
    struct Txen
    {
        static void connect();
        static_assert((peripheral == Peripheral::Eth), "GpioB11::Txen only connects to Eth!");
    };
    template <Peripheral peripheral>
    struct Ulpid4
    {
