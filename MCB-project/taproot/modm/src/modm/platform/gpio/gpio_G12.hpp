...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioG12::Ne4 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Rts
    {
        static void connect();
        static_assert((peripheral == Peripheral::Usart6), "GpioG12::Rts only connects to Usart6!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
struct GpioG12::Ne4<Peripheral::Fsmc>
{
    using Gpio = GpioG12;
