...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioD9::D14 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Da14
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioD9::Da14 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Rx
    {
        static void connect();
        static_assert((peripheral == Peripheral::Usart3), "GpioD9::Rx only connects to Usart3!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
struct GpioD9::D14<Peripheral::Fsmc>
{
    using Gpio = GpioD9;
...
template <>
struct GpioD9::Da14<Peripheral::Fsmc>
{
    using Gpio = GpioD9;
