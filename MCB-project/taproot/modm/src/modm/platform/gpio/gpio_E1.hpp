...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Dcmi), "GpioE1::D3 only connects to Dcmi!");
    };
    template <Peripheral peripheral>
    struct Nbl1
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioE1::Nbl1 only connects to Fsmc!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
struct GpioE1::Nbl1<Peripheral::Fsmc>
{
    using Gpio = GpioE1;
