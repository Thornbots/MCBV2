...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioD5::Nwe only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Tx
    {
        static void connect();
        static_assert((peripheral == Peripheral::Usart2), "GpioD5::Tx only connects to Usart2!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
struct GpioD5::Nwe<Peripheral::Fsmc>
{
    using Gpio = GpioD5;
