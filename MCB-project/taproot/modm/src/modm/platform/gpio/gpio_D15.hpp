...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim4), "GpioD15::Ch4 only connects to Tim4!");
    };
    template <Peripheral peripheral>
    struct D1
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioD15::D1 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Da1
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioD15::Da1 only connects to Fsmc!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
struct GpioD15::D1<Peripheral::Fsmc>
{
    using Gpio = GpioD15;
...
template <>
struct GpioD15::Da1<Peripheral::Fsmc>
{
    using Gpio = GpioD15;
