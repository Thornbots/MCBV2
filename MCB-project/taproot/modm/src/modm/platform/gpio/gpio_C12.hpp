...
public:
    ...
    struct Ck
    {
        static void connect();
        static_assert(
            (peripheral == Peripheral::Usart3) || (peripheral == Peripheral::Sdio),
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Dcmi), "GpioC12::D9 only connects to Dcmi!");
    };
    template <Peripheral peripheral>
    struct Mosi
    {
        static void connect();
        static_assert((peripheral == Peripheral::Spi3), "GpioC12::Mosi only connects to Spi3!");
    };
    template <Peripheral peripheral>
    struct Sd
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2s3), "GpioC12::Sd only connects to I2s3!");
    };
    template <Peripheral peripheral>
    struct Tx
    {
        static void connect();
        static_assert((peripheral == Peripheral::Uart5), "GpioC12::Tx only connects to Uart5!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
