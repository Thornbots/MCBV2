...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Usart2), "GpioD7::Ck only connects to Usart2!");
    };
    template <Peripheral peripheral>
    struct Nce2
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioD7::Nce2 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Ne1
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioD7::Ne1 only connects to Fsmc!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
struct GpioD7::Nce2<Peripheral::Fsmc>
{
    using Gpio = GpioD7;
...
template <>
struct GpioD7::Ne1<Peripheral::Fsmc>
{
    using Gpio = GpioD7;
