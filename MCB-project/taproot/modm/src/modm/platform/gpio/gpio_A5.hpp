...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim2), "GpioA5::Ch1 only connects to Tim2!");
    };
    template <Peripheral peripheral>
    struct Ch1n
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim8), "GpioA5::Ch1n only connects to Tim8!");
    };
    template <Peripheral peripheral>
    struct Etr
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim2), "GpioA5::Etr only connects to Tim2!");
    };
    template <Peripheral peripheral>
    struct In5
    {
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Dac), "GpioA5::Out2 only connects to Dac!");
    };
    template <Peripheral peripheral>
    struct Sck
    {
        static void connect();
        static_assert((peripheral == Peripheral::Spi1), "GpioA5::Sck only connects to Spi1!");
    };
    template <Peripheral peripheral>
    struct Ulpick
    {
...
template <>
constexpr int8_t GpioA5::AdcChannel<Peripheral::Adc1> = 5;
template <>
...
template <>
constexpr int8_t GpioA5::AdcChannel<Peripheral::Adc2> = 5;
template <>
...
template <>
constexpr int8_t GpioA5::DacChannel<Peripheral::Dac> = 2;
template <>
