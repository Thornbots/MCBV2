...
public:
    ...
    struct Ch1
    {
        static void connect();
        static_assert(
            (peripheral == Peripheral::Tim2) || (peripheral == Peripheral::Tim5),
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Eth), "GpioA0::Crs only connects to Eth!");
    };
    template <Peripheral peripheral>
    struct Cts
    {
        static void connect();
        static_assert((peripheral == Peripheral::Usart2), "GpioA0::Cts only connects to Usart2!");
    };
    template <Peripheral peripheral>
    struct Etr
    {
        static void connect();
        static_assert(
            (peripheral == Peripheral::Tim2) || (peripheral == Peripheral::Tim8),
    ...
    struct In0
    {
        static void connect();
        static_assert(
            (peripheral == Peripheral::Adc1) || (peripheral == Peripheral::Adc2) ||
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Uart4), "GpioA0::Tx only connects to Uart4!");
    };
    template <Peripheral peripheral>
    struct Wkup
    {
        static void connect();
        static_assert((peripheral == Peripheral::Sys), "GpioA0::Wkup only connects to Sys!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
struct GpioA0::Ch1<Peripheral::Tim2>
{
    ...
    static constexpr int af = 1;
    inline static void connect() { setAlternateFunction(1); }
};
template <>
struct GpioA0::Ch1<Peripheral::Tim5>
{
    ...
    inline static void connect() { setAlternateFunction(2); }
};
template <>
struct GpioA0::Crs<Peripheral::Eth>
{
    ...
    inline static void connect() { setAlternateFunction(11); }
};
template <>
struct GpioA0::Cts<Peripheral::Usart2>
{
    ...
    inline static void connect() { setAlternateFunction(7); }
};
template <>
...
struct GpioA0::Etr<Peripheral::Tim8>
{
    ...
    inline static void connect() { setAlternateFunction(3); }
};
template <>
...
template <>
constexpr int8_t GpioA0::AdcChannel<Peripheral::Adc1> = 0;
template <>
...
template <>
constexpr int8_t GpioA0::AdcChannel<Peripheral::Adc2> = 0;
template <>
...
template <>
constexpr int8_t GpioA0::AdcChannel<Peripheral::Adc3> = 0;
template <>
struct GpioA0::Tx<Peripheral::Uart4>
{
    ...
    inline static void connect() { setAlternateFunction(8); }
};
template <>
struct GpioA0::Wkup<Peripheral::Sys>
{
    ...
    inline static void connect() { setAlternateFunction(0); }
};
/// @endcond
