...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim2), "GpioB10::Ch3 only connects to Tim2!");
    };
    template <Peripheral peripheral>
    struct Ck
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2s2), "GpioB10::Ck only connects to I2s2!");
    };
    template <Peripheral peripheral>
    struct Rxer
    {
        static void connect();
        static_assert((peripheral == Peripheral::Eth), "GpioB10::Rxer only connects to Eth!");
    };
    template <Peripheral peripheral>
    struct Sck
    {
        static void connect();
        static_assert((peripheral == Peripheral::Spi2), "GpioB10::Sck only connects to Spi2!");
    };
    template <Peripheral peripheral>
    struct Scl
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2c2), "GpioB10::Scl only connects to I2c2!");
    };
    template <Peripheral peripheral>
    struct Tx
    {
        static void connect();
        static_assert((peripheral == Peripheral::Usart3), "GpioB10::Tx only connects to Usart3!");
    };
    template <Peripheral peripheral>
    struct Ulpid3
    {
