...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioD1::D3 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Da3
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioD1::Da3 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Tx
    {
        static void connect();
        static_assert((peripheral == Peripheral::Can1), "GpioD1::Tx only connects to Can1!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
struct GpioD1::D3<Peripheral::Fsmc>
{
    using Gpio = GpioD1;
...
template <>
struct GpioD1::Da3<Peripheral::Fsmc>
{
    using Gpio = GpioD1;
