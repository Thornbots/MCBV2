...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioF5::A5 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct In15
    {
        static void connect();
        static_assert((peripheral == Peripheral::Adc3), "GpioF5::In15 only connects to Adc3!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
struct GpioF5::A5<Peripheral::Fsmc>
{
    using Gpio = GpioF5;
...
template <>
constexpr int8_t GpioF5::AdcChannel<Peripheral::Adc3> = 15;
/// @endcond
