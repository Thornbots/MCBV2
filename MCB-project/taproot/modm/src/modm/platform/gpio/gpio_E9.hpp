...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim1), "GpioE9::Ch1 only connects to Tim1!");
    };
    template <Peripheral peripheral>
    struct D6
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioE9::D6 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Da6
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioE9::Da6 only connects to Fsmc!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
struct GpioE9::D6<Peripheral::Fsmc>
{
    using Gpio = GpioE9;
...
template <>
struct GpioE9::Da6<Peripheral::Fsmc>
{
    using Gpio = GpioE9;
