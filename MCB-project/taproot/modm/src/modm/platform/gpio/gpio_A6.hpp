...
public:
    ...
    struct Ch1
    {
        static void connect();
        static_assert(
            (peripheral == Peripheral::Tim3) || (peripheral == Peripheral::Tim13),
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Spi1), "GpioA6::Miso only connects to Spi1!");
    };
    template <Peripheral peripheral>
    struct Pixclk
    {
        static void connect();
        static_assert((peripheral == Peripheral::Dcmi), "GpioA6::Pixclk only connects to Dcmi!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
constexpr int8_t GpioA6::AdcChannel<Peripheral::Adc1> = 6;
template <>
...
template <>
constexpr int8_t GpioA6::AdcChannel<Peripheral::Adc2> = 6;
template <>
