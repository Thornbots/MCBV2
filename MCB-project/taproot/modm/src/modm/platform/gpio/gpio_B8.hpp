...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim10), "GpioB8::Ch1 only connects to Tim10!");
    };
    template <Peripheral peripheral>
    struct Ch3
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim4), "GpioB8::Ch3 only connects to Tim4!");
    };
    template <Peripheral peripheral>
    struct D4
    {
        static void connect();
        static_assert((peripheral == Peripheral::Sdio), "GpioB8::D4 only connects to Sdio!");
    };
    template <Peripheral peripheral>
    struct D6
    {
        static void connect();
        static_assert((peripheral == Peripheral::Dcmi), "GpioB8::D6 only connects to Dcmi!");
    };
    template <Peripheral peripheral>
    struct Rx
    {
        static void connect();
        static_assert((peripheral == Peripheral::Can1), "GpioB8::Rx only connects to Can1!");
    };
    template <Peripheral peripheral>
    struct Scl
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2c1), "GpioB8::Scl only connects to I2c1!");
    };
    template <Peripheral peripheral>
    struct Txd3
    {
        static void connect();
        static_assert((peripheral == Peripheral::Eth), "GpioB8::Txd3 only connects to Eth!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
