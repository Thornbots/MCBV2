...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim3), "GpioB5::Ch2 only connects to Tim3!");
    };
    template <Peripheral peripheral>
    struct D10
    {
        static void connect();
        static_assert((peripheral == Peripheral::Dcmi), "GpioB5::D10 only connects to Dcmi!");
    };
    template <Peripheral peripheral>
    struct Mosi
    {
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Eth), "GpioB5::Ppsout only connects to Eth!");
    };
    template <Peripheral peripheral>
    struct Rx
    {
        static void connect();
        static_assert((peripheral == Peripheral::Can2), "GpioB5::Rx only connects to Can2!");
    };
    template <Peripheral peripheral>
    struct Sd
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2s3), "GpioB5::Sd only connects to I2s3!");
    };
    template <Peripheral peripheral>
    struct Smba
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2c1), "GpioB5::Smba only connects to I2c1!");
    };
    template <Peripheral peripheral>
    struct Ulpid7
    {
