...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim12), "GpioH6::Ch1 only connects to Tim12!");
    };
    template <Peripheral peripheral>
    struct Rxd2
    {
        static void connect();
        static_assert((peripheral == Peripheral::Eth), "GpioH6::Rxd2 only connects to Eth!");
    };
    template <Peripheral peripheral>
    struct Smba
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2c2), "GpioH6::Smba only connects to I2c2!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
