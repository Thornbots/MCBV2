...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Sdio), "GpioD2::Cmd only connects to Sdio!");
    };
    template <Peripheral peripheral>
    struct D11
    {
        static void connect();
        static_assert((peripheral == Peripheral::Dcmi), "GpioD2::D11 only connects to Dcmi!");
    };
    template <Peripheral peripheral>
    struct Etr
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim3), "GpioD2::Etr only connects to Tim3!");
    };
    template <Peripheral peripheral>
    struct Rx
    {
        static void connect();
        static_assert((peripheral == Peripheral::Uart5), "GpioD2::Rx only connects to Uart5!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
