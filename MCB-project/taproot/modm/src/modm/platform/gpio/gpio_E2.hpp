...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioE2::A23 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Traceclk
    {
        static void connect();
        static_assert((peripheral == Peripheral::Sys), "GpioE2::Traceclk only connects to Sys!");
    };
    template <Peripheral peripheral>
    struct Txd3
    {
        static void connect();
        static_assert((peripheral == Peripheral::Eth), "GpioE2::Txd3 only connects to Eth!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
struct GpioE2::A23<Peripheral::Fsmc>
{
    using Gpio = GpioE2;
