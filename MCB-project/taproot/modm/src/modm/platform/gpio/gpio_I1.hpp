...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2s2), "GpioI1::Ck only connects to I2s2!");
    };
    template <Peripheral peripheral>
    struct D8
    {
        static void connect();
        static_assert((peripheral == Peripheral::Dcmi), "GpioI1::D8 only connects to Dcmi!");
    };
    template <Peripheral peripheral>
    struct Sck
    {
        static void connect();
        static_assert((peripheral == Peripheral::Spi2), "GpioI1::Sck only connects to Spi2!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
