...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioG10::Nce41 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Ne3
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioG10::Ne3 only connects to Fsmc!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
struct GpioG10::Nce41<Peripheral::Fsmc>
{
    using Gpio = GpioG10;
...
template <>
struct GpioG10::Ne3<Peripheral::Fsmc>
{
    using Gpio = GpioG10;
