...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioG13::A24 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Cts
    {
        static void connect();
        static_assert((peripheral == Peripheral::Usart6), "GpioG13::Cts only connects to Usart6!");
    };
    template <Peripheral peripheral>
    struct Txd0
    {
        static void connect();
        static_assert((peripheral == Peripheral::Eth), "GpioG13::Txd0 only connects to Eth!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
struct GpioG13::A24<Peripheral::Fsmc>
{
    using Gpio = GpioG13;
