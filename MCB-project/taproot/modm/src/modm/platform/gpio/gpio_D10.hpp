...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Usart3), "GpioD10::Ck only connects to Usart3!");
    };
    template <Peripheral peripheral>
    struct D15
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioD10::D15 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Da15
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioD10::Da15 only connects to Fsmc!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
struct GpioD10::D15<Peripheral::Fsmc>
{
    using Gpio = GpioD10;
...
template <>
struct GpioD10::Da15<Peripheral::Fsmc>
{
    using Gpio = GpioD10;
