...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Eth), "GpioC5::Rxd1 only connects to Eth!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
constexpr int8_t GpioC5::AdcChannel<Peripheral::Adc1> = 15;
template <>
...
template <>
constexpr int8_t GpioC5::AdcChannel<Peripheral::Adc2> = 15;
template <>
