...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioD3::Clk only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Cts
    {
        static void connect();
        static_assert((peripheral == Peripheral::Usart2), "GpioD3::Cts only connects to Usart2!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
