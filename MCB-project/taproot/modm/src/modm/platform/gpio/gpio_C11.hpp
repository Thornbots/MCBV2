...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Sdio), "GpioC11::D3 only connects to Sdio!");
    };
    template <Peripheral peripheral>
    struct D4
    {
        static void connect();
        static_assert((peripheral == Peripheral::Dcmi), "GpioC11::D4 only connects to Dcmi!");
    };
    template <Peripheral peripheral>
    struct Extsd
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2s3), "GpioC11::Extsd only connects to I2s3!");
    };
    template <Peripheral peripheral>
    struct Miso
    {
        static void connect();
        static_assert((peripheral == Peripheral::Spi3), "GpioC11::Miso only connects to Spi3!");
    };
    template <Peripheral peripheral>
    struct Rx
    {
        static void connect();
        static_assert(
            (peripheral == Peripheral::Usart3) || (peripheral == Peripheral::Uart4),
