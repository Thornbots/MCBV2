...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim12), "GpioH9::Ch2 only connects to Tim12!");
    };
    template <Peripheral peripheral>
    struct D0
    {
        static void connect();
        static_assert((peripheral == Peripheral::Dcmi), "GpioH9::D0 only connects to Dcmi!");
    };
    template <Peripheral peripheral>
    struct Smba
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2c3), "GpioH9::Smba only connects to I2c3!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
