...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim4), "GpioB6::Ch1 only connects to Tim4!");
    };
    template <Peripheral peripheral>
    struct D5
    {
        static void connect();
        static_assert((peripheral == Peripheral::Dcmi), "GpioB6::D5 only connects to Dcmi!");
    };
    template <Peripheral peripheral>
    struct Scl
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2c1), "GpioB6::Scl only connects to I2c1!");
    };
    template <Peripheral peripheral>
    struct Tx
    {
        static void connect();
        static_assert(
            (peripheral == Peripheral::Usart1) || (peripheral == Peripheral::Can2),
