...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioD4::Noe only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Rts
    {
        static void connect();
        static_assert((peripheral == Peripheral::Usart2), "GpioD4::Rts only connects to Usart2!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
