...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim1), "GpioE15::Bkin only connects to Tim1!");
    };
    template <Peripheral peripheral>
    struct D12
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioE15::D12 only connects to Fsmc!");
    };
    template <Peripheral peripheral>
    struct Da12
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioE15::Da12 only connects to Fsmc!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
struct GpioE15::D12<Peripheral::Fsmc>
{
    using Gpio = GpioE15;
...
template <>
struct GpioE15::Da12<Peripheral::Fsmc>
{
    using Gpio = GpioE15;
