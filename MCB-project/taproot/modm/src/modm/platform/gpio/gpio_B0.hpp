...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim3), "GpioB0::Ch3 only connects to Tim3!");
    };
    template <Peripheral peripheral>
    struct In8
    {
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Eth), "GpioB0::Rxd2 only connects to Eth!");
    };
    template <Peripheral peripheral>
    struct Ulpid1
    {
...
template <>
constexpr int8_t GpioB0::AdcChannel<Peripheral::Adc1> = 8;
template <>
...
template <>
constexpr int8_t GpioB0::AdcChannel<Peripheral::Adc2> = 8;
template <>
