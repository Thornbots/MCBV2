...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim11), "GpioB9::Ch1 only connects to Tim11!");
    };
    template <Peripheral peripheral>
    struct Ch4
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim4), "GpioB9::Ch4 only connects to Tim4!");
    };
    template <Peripheral peripheral>
    struct D5
    {
        static void connect();
        static_assert((peripheral == Peripheral::Sdio), "GpioB9::D5 only connects to Sdio!");
    };
    template <Peripheral peripheral>
    struct D7
    {
        static void connect();
        static_assert((peripheral == Peripheral::Dcmi), "GpioB9::D7 only connects to Dcmi!");
    };
    template <Peripheral peripheral>
    struct Nss
    {
        static void connect();
        static_assert((peripheral == Peripheral::Spi2), "GpioB9::Nss only connects to Spi2!");
    };
    template <Peripheral peripheral>
    struct Sda
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2c1), "GpioB9::Sda only connects to I2c1!");
    };
    template <Peripheral peripheral>
    struct Tx
    {
        static void connect();
        static_assert((peripheral == Peripheral::Can1), "GpioB9::Tx only connects to Can1!");
    };
    template <Peripheral peripheral>
    struct Ws
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2s2), "GpioB9::Ws only connects to I2s2!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
struct GpioB9::D5<Peripheral::Sdio>
{
    ...
    inline static void connect() { setAlternateFunction(12); }
};
template <>
struct GpioB9::D7<Peripheral::Dcmi>
{
    ...
    inline static void connect() { setAlternateFunction(13); }
};
template <>
struct GpioB9::Nss<Peripheral::Spi2>
{
    ...
    inline static void connect() { setAlternateFunction(5); }
};
template <>
...
struct GpioB9::Tx<Peripheral::Can1>
{
    ...
    inline static void connect() { setAlternateFunction(9); }
};
template <>
