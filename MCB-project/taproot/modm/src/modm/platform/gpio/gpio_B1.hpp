...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim3), "GpioB1::Ch4 only connects to Tim3!");
    };
    template <Peripheral peripheral>
    struct In9
    {
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Eth), "GpioB1::Rxd3 only connects to Eth!");
    };
    template <Peripheral peripheral>
    struct Ulpid2
    {
...
template <>
constexpr int8_t GpioB1::AdcChannel<Peripheral::Adc1> = 9;
template <>
...
template <>
constexpr int8_t GpioB1::AdcChannel<Peripheral::Adc2> = 9;
template <>
