...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Adc3), "GpioF10::In8 only connects to Adc3!");
    };
    template <Peripheral peripheral>
    struct Intr
    {
        static void connect();
        static_assert((peripheral == Peripheral::Fsmc), "GpioF10::Intr only connects to Fsmc!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
...
template <>
constexpr int8_t GpioF10::AdcChannel<Peripheral::Adc3> = 8;
template <>
struct GpioF10::Intr<Peripheral::Fsmc>
{
    using Gpio = GpioF10;
