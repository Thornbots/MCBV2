...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim1), "GpioB12::Bkin only connects to Tim1!");
    };
    template <Peripheral peripheral>
    struct Ck
    {
        static void connect();
        static_assert((peripheral == Peripheral::Usart3), "GpioB12::Ck only connects to Usart3!");
    };
    template <Peripheral peripheral>
    struct Id
    {
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Spi2), "GpioB12::Nss only connects to Spi2!");
    };
    template <Peripheral peripheral>
    struct Rx
    {
        static void connect();
        static_assert((peripheral == Peripheral::Can2), "GpioB12::Rx only connects to Can2!");
    };
    template <Peripheral peripheral>
    struct Smba
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2c2), "GpioB12::Smba only connects to I2c2!");
    };
    template <Peripheral peripheral>
    struct Txd0
    {
        static void connect();
        static_assert((peripheral == Peripheral::Eth), "GpioB12::Txd0 only connects to Eth!");
    };
    template <Peripheral peripheral>
    struct Ulpid5
    {
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2s2), "GpioB12::Ws only connects to I2s2!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
