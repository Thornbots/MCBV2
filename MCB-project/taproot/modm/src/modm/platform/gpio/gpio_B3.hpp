...
public:
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Tim2), "GpioB3::Ch2 only connects to Tim2!");
    };
    template <Peripheral peripheral>
    struct Ck
    {
        static void connect();
        static_assert((peripheral == Peripheral::I2s3), "GpioB3::Ck only connects to I2s3!");
    };
    template <Peripheral peripheral>
    struct Jtdo
    {
        static void connect();
        static_assert((peripheral == Peripheral::Sys), "GpioB3::Jtdo only connects to Sys!");
    };
    template <Peripheral peripheral>
    struct Sck
    {
    ...
    {
        static void connect();
        static_assert((peripheral == Peripheral::Sys), "GpioB3::Swo only connects to Sys!");
    };
    /// @endcond
private:
    template <Peripheral peripheral>
