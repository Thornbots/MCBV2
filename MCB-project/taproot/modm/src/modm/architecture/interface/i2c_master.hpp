...
public:
    ...
    enum class ResetDevices : uint32_t
    {
...
public:
     ...
     * @tparam	reset
     * 		Choose a speed to reset the I2C devices with. Can be disabled with
     *`ResetDevices::NoReset`.
     * @param	pullups
     * 		Use external or weak internal pullups.
     */
    template <class... Signals, ResetDevices reset = ResetDevices::Standard>
    static void connect(PullUps pullups = PullUps::External);
