...
struct I2c
{
    ...
    enum class OperationAfterStart : uint8_t
    {
    ...
    enum class OperationAfterWrite : uint8_t
    {
        Stop = uint8_t(Operation::Stop),        ///< Generate a Stop Condition
    ...
    enum class OperationAfterRead : uint8_t
    {
        Stop = uint8_t(Operation::Stop),        ///< Generate a Stop Condition
        Restart = uint8_t(Operation::Restart),  ///< Generate a Restart
    };
...
inline modm::IOStream& operator<<(modm::IOStream& s, const modm::I2c::DetachCause detach_cause)
{
    switch (detach_cause)
    {
        case modm::I2c::DetachCause::NormalStop:
            s << "NormalStop";
            break;
        case modm::I2c::DetachCause::ErrorCondition:
            s << "ErrorCondition";
            break;
        case modm::I2c::DetachCause::FailedToAttach:
            s << "FailedToAttach";
            break;
    }
    return s;
...
inline modm::IOStream& operator<<(modm::IOStream& s, const modm::I2c::Operation op)
{
    switch (op)
    {
...
inline modm::IOStream& operator<<(modm::IOStream& s, const modm::I2c::OperationAfterStart op)
{
    s << static_cast<modm::I2c::Operation>(op);
    return s;
}

inline modm::IOStream& operator<<(modm::IOStream& s, const modm::I2c::OperationAfterRead op)
{
    s << static_cast<modm::I2c::Operation>(op);
    return s;
}

inline modm::IOStream& operator<<(modm::IOStream& s, const modm::I2c::OperationAfterWrite op)
{
    s << static_cast<modm::I2c::Operation>(op);
    return s;
}
